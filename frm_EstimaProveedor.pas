...
uses
  ...
  RXCtrls, CheckLst, HintComponent, Newpanel, DisPanel,
  PanelDown, ZAbstractRODataset, ZDataset, masUtilerias,
  rxToolEdit, rxCurrEdit,  UnitExcepciones, udbgrid, UnitValidaTexto,
...
begin
  try
    ...
    begin
        ...
        frGenerador.LoadFromFile (global_files + 'ResumenGeneracionSubContratos.fr3') ;
        ...
        if not FileExists(global_files + 'ResumenGeneracionSubContratos.fr3') then
