...
uses
  ...
  udbgrid, ZDataset, rxToolEdit, Mask, Grids, DBGrids, Menus,
  UnitTBotonesPermisos, UnitExcepciones, ComCtrls, DBDateTimePicker, DateUtils,
  ExcelXP, ComObj, Excel2000, OleServer, ExtCtrls, Buttons, frm_BusquedaGeneralizada, StrUtils,
  ADODB, frm_MensajesGenerales, AdvSplitter,CommCtrl, UFunctionsGHH;
...
type
  TFrmMovtosPersonalxoficio = class(TForm)
    ...
    procedure movtosPersEqDeleteError(DataSet: TDataSet; E: EDatabaseError;
      var Action: TDataAction);
    procedure dBPersonalDblClick(Sender: TObject);
    ...
    procedure dBPersonalKeyPress(Sender: TObject; var Key: Char);
    ...
    procedure dBPersonalKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
procedure TFrmMovtosPersonalxoficio.FormCreate(Sender: TObject);
begin
  ListaContratos:=TStringList.Create;
end;

procedure TFrmMovtosPersonalxoficio.CargarArbol;
var
    nodo, hijo,
    nodoprim    : TTreeNode;
    apNodo      :tbookmark;
...
begin
  try
    if (dbpersonal.DataSource.DataSet.IsEmpty = false) or (dbpersonal.DataSource.DataSet.RecordCount > 0) then
    begin
...
begin
  try
    ...
    connection.zCommand.SQL.Add('UPDATE movtorecursosxoficio m,  personal p set m.iItemOrden=p.iItemOrden ' +
      'Where m.sContrato=p.sContrato and sNumeroOrden=:Orden And m.sNumeroActividad=p.sIdPersonal ' +
    ...
    connection.zCommand.SQL.Add('UPDATE movtorecursosxoficio m,  equipos e set m.iItemOrden=e.iItemOrden ' +
      'Where m.sContrato=e.sContrato and sNumeroOrden=:Orden And m.sNumeroActividad=e.sIdEquipo ' +
      'And m.sContrato =:Contrato ');
    connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
    connection.zCommand.Params.ParamByName('Contrato').value := param_global_contrato;
    connection.zCommand.ParamByName('Orden').AsString:=Param_Frente;
      ...
      if rbC14.Checked then
        if QryOrdenesGral.FieldValues['sTipoVigencia'] = 'DIARIA' then
          connection.QryBusca.SQL.Add('select d.*, p.iItemOrden, p.sDescripcion, p.sMedida, m.dCantidad as dCantidadOficio from detallerecursosxoficio d ' +
            ...
            'where d.sContrato =:Contrato and m.sNumeroOrden=:Orden and d.iFolioOficio =:Oficio and d.sAnexo =:Anexo group by d.sAnexo, d.sNumeroActividad order by p.iItemOrden')
        else
          connection.QryBusca.SQL.Add('select d.*, p.iItemOrden, p.sDescripcion, p.sMedida, d.dCantidad as dCantidadOficio from movtorecursosxoficio d ' +
            ' inner join personal p on (p.sContrato = d.sContrato and p.sIdPersonal = d.sNumeroActividad) ' +
            ' where d.sContrato =:Contrato and d.sNumeroOrden=:Orden and d.iFolioOficio =:Oficio and d.sAnexo =:Anexo group by d.sAnexo, d.sNumeroActividad order by p.iItemOrden;');
    ...
    //Equipo DMO
      if rbC15.Checked then
        if QryOrdenesGral.FieldValues['sTipoVigencia'] = 'DIARIA' then
          ...
          connection.QryBusca.SQL.Add('select d.*, p.iItemOrden, p.sDescripcion, p.sMedida, d.dCantidad as dCantidadOficio from movtorecursosxoficio d ' +
            ' inner join equipos p on (p.sContrato = d.sContrato and p.sIdEquipo = d.sNumeroActividad) ' +
            ' where d.sContrato =:Contrato and d.sNumeroOrden=:Orden and d.iFolioOficio =:Oficio and d.sAnexo =:Anexo ' +
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Q_Partidas.Params.ParamByName('Contrato').Value := param_global_contrato;
  ...
  try
    ...
    begin
      ...
      Connection.QryBusca.SQL.Add(' select iItemOrden as Item, sIdPersonal as Id, sDescripcion from personal ' +
        ...
        '    movtorecursosxoficio where sContrato=:Contrato and sNumeroOrden=:Orden and sAnexo=:anexo and iFolioOficio=:folio and sNumeroActividad=personal.sIdPersonal) ' +
        ' Order By iItemOrden ');
      Connection.QryBusca.Params.ParamByName('anexo').DataType := ftString;
    ...
    begin
      ...
      Connection.QryBusca.SQL.Add('select iItemOrden as Item, sIdEquipo as Id, sDescripcion from equipos ' +
        ...
        '    movtorecursosxoficio where sContrato=:Contrato and sNumeroOrden=:Orden and sAnexo=:anexo and iFolioOficio=:folio and sNumeroActividad=equipos.sIdEquipo) ' +
        ' Order By iItemOrden ');
      Connection.QryBusca.Params.ParamByName('anexo').DataType := ftString;
    ...
    begin
      ...
      Connection.QryBusca.SQL.Add('select sIdCuenta as Item, sIdPernocta as Id, sDescripcion from cuentas  where not exists(select sNumeroActividad from ' +
        '    movtorecursosxoficio where sContrato=:Contrato and sNumeroOrden=:Orden and sAnexo=:anexo and iFolioOficio=:folio and sNumeroActividad=cuentas.sIdPernocta) ' +
        ' Order By sIdCuenta ');
      Connection.QryBusca.Params.ParamByName('anexo').DataType := ftString;
    ...
    begin
      ...
      begin
        ...
        Movtosrecursos.FieldValues['sContrato'] := param_global_contrato;
        Movtosrecursos.FieldValues['sNumeroOrden'] := Param_Frente;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
          'and sNumeroOrden=:Orden And iFolioOficio = :Folio and sAnexo="' + global_labelPersonal + '" ');
        connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
        connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
    ...
    begin
      ...
      begin
        ...
        connection.zCommand.SQL.Clear;
        connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
          'and sNumeroOrden=:Orden And iFolioOficio = :Folio and sAnexo="' + global_labelEquipo + '" ');
        connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
        connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
        connection.zCommand.ParamByName('Orden').AsString:=Param_Frente;
        connection.zCommand.Params.ParamByName('Folio').DataType := ftInteger;
    ...
    begin
      ...
      begin
        ...
        connection.zCommand.SQL.Clear;
        connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
          'and sNumeroOrden=:Orden And iFolioOficio = :Folio and sAnexo="' + global_labelPernocta + '" ');
        connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
        connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
        connection.zCommand.ParamByName('Orden').AsString:=Param_Frente;
        connection.zCommand.Params.ParamByName('Folio').DataType := ftInteger;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            qryBuscar.Params.ParamByName('contrato').AsString := param_global_contrato;
            qryBuscar.Open;
            ...
            {Leer la distribuicion con las fechas}
              ...
              {si es el ultimo campo, insertar el movimiento }
                  ...
                  begin
                    ...
                    qry2.ParamByName('contrato').AsString := param_global_contrato;
                    qry2.ParamByName('orden').AsString := Param_Frente;
...
procedure TFrmMovtosPersonalxoficio.dBPersonalDblClick(Sender: TObject);
begin
...
procedure TFrmMovtosPersonalxoficio.dBPersonalKeyDown(Sender: TObject;
...
procedure TFrmMovtosPersonalxoficio.dBPersonalKeyPress(Sender: TObject;
  var Key: Char);
var
    ...
    if dbpersonal.SelectedField.FullName = 'sNumeroActividad' then
      ...
      begin
        ...
        begin
          ...
          dbpersonal.DataSource.DataSet.FieldValues['sNumeroActividad'] := frmBusquedaGeneralizada.Qry.FieldValues['Clave'];
        end;
...
procedure TFrmMovtosPersonalxoficio.dBPersonalTitleClick(Column: TColumn);
begin
  try
...
begin
  try
    ...
    begin
      ...
      connection.zCommand.SQL.Clear;
      connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
        'and sNumeroOrden=:Orden And iFolioOficio = :Folio And sAnexo = "' + global_labelPersonal + '" And dCantidad=0 ');
      connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
      connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
      connection.zCommand.Params.ParamByName('Folio').DataType := ftInteger;
      connection.zCommand.Params.ParamByName('Folio').Value := iFolioOficio; //fechaVigencia.FieldValues['iFolioOficio'];
    ...
    begin
      ...
      connection.zCommand.SQL.Clear;
      connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
        'and sNumeroOrden=:Orden And iFolioOficio = :Folio And sAnexo = "' + global_labelEquipo + '" And dCantidad=0');
      connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
      connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
      connection.zCommand.Params.ParamByName('Folio').DataType := ftInteger;
      connection.zCommand.Params.ParamByName('Folio').Value := iFolioOficio; //fechaVigencia.FieldValues['iFolioOficio'];
    ...
    if (connection.zCommand.RecordCount > 0)  and (Connection.configuracion.FieldValues['lSeguridadVigencia'] = 'Si') then
      ...
      connection.zCommand.SQL.Clear;
      connection.zCommand.SQL.Add('DELETE FROM movtorecursosxoficio Where sContrato = :contrato ' +
        'and sNumeroOrden=:Orden And iFolioOficio = :Folio And sAnexo = "' + global_labelPernocta + '" And dCantidad=0');
      connection.zCommand.Params.ParamByName('Contrato').DataType := ftString;
      connection.zCommand.Params.ParamByName('Contrato').Value := param_global_contrato;
      connection.zCommand.Params.ParamByName('Folio').DataType := ftInteger;
      connection.zCommand.Params.ParamByName('Folio').Value := iFolioOficio; // fechaVigencia.FieldValues['iFolioOficio'];
...
begin
  ...
  begin
    ...
    movtosPersEq.FieldValues['sContrato'] := param_global_contrato;
...
begin
  ...
  movtosPersEq.FieldByName('sAnexo').AsString := Bandera;
...
begin
  ...
  begin
    ...
    Connection.Auxiliar.SQL.Add('Select sNumeroActividad from movtorecursosxoficio Where sContrato=:Contrato ' +
                                'and sNumeroOrden=:Orden And sNumeroActividad =:Actividad And sAnexo="' + global_labelPersonal + '" And dFechaVigencia =:Fecha');
    movtosPersEq.FieldValues['sAnexo'] := global_labelPersonal
  end;
  ...
  begin
    Connection.Auxiliar.SQL.Clear;
    Connection.Auxiliar.SQL.Add('Select sNumeroActividad from movtorecursosxoficio Where sContrato =:Contrato ' +
      'and sNumeroOrden=:Orden And sNumeroActividad =:Actividad And sAnexo="' + global_labelEquipo + '" And dFechaVigencia =:Fecha ');
    movtosPersEq.FieldValues['sAnexo'] := global_labelEquipo
  end;
  ...
  begin
    Connection.Auxiliar.SQL.Clear;
    Connection.Auxiliar.SQL.Add('Select sNumeroActividad from movtorecursosxoficio Where sContrato =:Contrato ' +
      'and sNumeroOrden=:Orden And sNumeroActividad =:Actividad And sAnexo="' + global_labelPernocta + '" And dFechaVigencia =:Fecha ');
    movtosPersEq.FieldValues['sAnexo'] := global_labelPernocta
  end;
  ...
  begin
    ...
    Connection.Auxiliar.ParamByName('Orden').AsString:=Param_Frente;
...
begin
  ...
  begin
    ...
    MovtosPersEq.SQL.Add('select * from movtorecursosxoficio ' +
      'where sContrato =:Contrato And iFolioOficio =:Folio AND sNumeroOrden = :NumeroDeOrden ' +
      'And sAnexo="' + Bandera + '" Order by iItemOrden');
    MovtosPersEq.Params.ParamByName('Contrato').DataType := ftString;
    MovtosPersEq.Params.ParamByName('Contrato').Value := param_global_contrato;
    MovtosPersEq.Params.ParamByName('Folio').DataType := ftInteger;
    MovtosPersEq.Params.ParamByName('Folio').Value := iFolioOficio;
    MovtosPersEq.Params.ParamByName('NumeroDeOrden').DataType := ftString;
    MovtosPersEq.Params.ParamByName('NumeroDeOrden').Value := Param_Frente;
    MovtosPersEq.Open;
    sumaPersonal();
  end;
end;
...
begin
  try
    ...
    begin
      ...
      qryOrdenesGral.Params.ParamByName('Contrato').Value := param_global_contrato;
      qryOrdenesGral.Params.ParamByName('Folio').DataType := ftInteger;
      qryOrdenesGral.Params.ParamByName('Folio').Value := iFolioOficio;
      qryOrdenesGral.Params.ParamByName('NumeroDeOrden').DataType := ftString;
      qryOrdenesGral.Params.ParamByName('NumeroDeOrden').Value := Param_Frente;
      qryOrdenesGral.Open;
...
procedure TFrmMovtosPersonalxoficio.tsOficioAutorizacionKeyPress(
...
procedure TFrmMovtosPersonalxoficio.tvFrentesChange(Sender: TObject;
  Node: TTreeNode);
begin
  ...
  fechaVigencia.ParamByName('Contrato').AsString := param_global_contrato;
  fechaVigencia.ParamByName('Orden').AsString:=Param_Frente;
  fechaVigencia.Open;
end;

procedure TFrmMovtosPersonalxoficio.tvFrentesCollapsing(Sender: TObject;
  Node: TTreeNode; var AllowCollapse: Boolean);
begin
  AllowCollapse:=False;
end;

procedure TFrmMovtosPersonalxoficio.tvFrentesCustomDrawItem(
...
begin
  ...
  begin
    ...
    begin
      Sender.Canvas.Font.Color := clwhite;//clmaroon;
      sender.Canvas.Font.Style:=[fsbold];
    end;
end;
    ...
    //Equipo DMO
      ...
      begin
        ...
        begin
          ...
          Q_Partidas2.Params.ParamByName('Contrato').Value := param_global_contrato;
