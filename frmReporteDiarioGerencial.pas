...
uses
  ...
  Dialogs, RXCtrls, StdCtrls, ComCtrls, ImgList, frm_connection,
  DB, global, Newpanel, Buttons, RxMemDS, frxClass,
  ...
  Begin
      If Connection.configuracion.FieldValues['lIncluyeGrafica'] = 'Si' Then
          If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
              frxGerencial.LoadFromFile(global_files + 'rGerencialMultipleConOrdenes.fr3')
          Else
             frxGerencial.LoadFromFile(global_files + 'rGerencialConOrdenes.fr3')
      Else
          If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
              frxGerencial.LoadFromFile(global_files + 'rGerencialMultipleSinGraficasConOrdenes.fr3')
          Else
             frxGerencial.LoadFromFile(global_files + 'rGerencialSinGraficasConOrdenes.fr3') ;
  End
  Else
      ...
      Begin
          If Connection.configuracion.FieldValues['lIncluyeGrafica'] = 'Si' Then
              If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
                  frxGerencial.LoadFromFile(global_files + 'rGerencialMultipleConOrdenesSinAvance.fr3')
              Else
                 frxGerencial.LoadFromFile(global_files + 'rGerencialConOrdenesSinAvance.fr3')
          Else
              If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
                  frxGerencial.LoadFromFile(global_files + 'rGerencialMultipleSinGraficasConOrdenesSinAvance.fr3')
              Else
                  frxGerencial.LoadFromFile(global_files + 'rGerencialSinGraficasConOrdenesSinAvance.fr3') ;
      End
      Else
      Begin
          If Connection.configuracion.FieldValues['lIncluyeGrafica'] = 'Si' Then
              If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
                  frxGerencial.LoadFromFile(global_files + 'rGerencialMultiple.fr3')
              Else
                 frxGerencial.LoadFromFile(global_files + 'rGerencial.fr3')
          Else
              If connection.configuracion.FieldValues['sFotografias'] = '2'  Then
                  frxGerencial.LoadFromFile(global_files + 'rGerencialMultipleSinGraficas.fr3')
              Else
                 frxGerencial.LoadFromFile(global_files + 'rGerencialSinGraficas.fr3') ;
      End ;
