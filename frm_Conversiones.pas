...
uses
  ...
  StdCtrls, global, udbgrid, UnitExcepciones;
...
begin
  txtdato.Color:= global_color_entrada;
end;

procedure TfrmConversiones.txtDatoExit(Sender: TObject);
begin
txtdato.Color:= global_color_salida;
end;
...
begin
txtresultado.Color:= global_color_entrada;
end;

procedure TfrmConversiones.txtResultadoExit(Sender: TObject);
begin
txtresultado.Color:= global_color_salida;
end;
...
begin
dbconversiones.Color:= global_color_entrada;
end;
...
begin
  try
    ...
    zrConsulta.Open ;
    dbconversiones.Color:= global_color_salida;
  except
...
begin
cmbconversion.Color:= global_color_entrada;
end;
...
begin
  try
    ...
    cmbconversion.Color:= global_color_salida;
  except
    on e : exception do begin
