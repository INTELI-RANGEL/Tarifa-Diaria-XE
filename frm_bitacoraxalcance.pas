...
uses
  ...
  frm_barra, DBCtrls, Mask, Global, Menus, Buttons, Utilerias, ExtCtrls, 
  frxClass, RXDBCtrl, RxMemDS, CheckLst, RxLookup, 
  ...
  UnitExcepciones, UnitValidaTexto, UFunctionsGHH, 
  masUtilerias;
  ...
  begin
    ...
    try
      if lKardex then begin
        ...
        Kardex('Reporte Diario', opcKardex, fechaKardex, 'Fecha', tsNumeroOrden.Text, '', '','Tarifa Diaria','Volumenes de Obra Y Nota');
      end;
    except
      on e: exception do begin
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        Kardex('Reporte Diario', opcKardex, fechaKardex, 'Fecha', tsNumeroOrden.Text, '', '', 'Tarifa Diaria','Bitacora de Alcances');
      except
        on e: exception do begin
