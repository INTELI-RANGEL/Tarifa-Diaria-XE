...
procedure TfrmRecursosPernocta.grid_pernoctanMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmRecursosPernocta.grid_pernoctanMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
 UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmRecursosPernocta.grid_pernoctanTitleClick(Column: TColumn);
begin
...
procedure TfrmRecursosPernocta.Copiar1Click(Sender: TObject);
begin
