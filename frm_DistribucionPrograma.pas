 ...
 Begin
    ...
    Begin
        ...
        Begin
             ...
             dFechaInicial := Connection.qryBusca2.FieldByName('dfiProgramado').AsDateTime ;
             dPonderadoglobal := 0 ;
             While Int(dFechaInicial) <= Int(Connection.qryBusca2.FieldByName('dffProgramado').AsDateTime)  Do
             Begin
                 ...
                 If Int(dFechaInicial) = Int(Connection.qryBusca2.FieldValues['dffProgramado']) then
                 ...
                 connection.zCommand.Active := False ;
                 connection.zCommand.SQL.Clear ;
                 connection.zCommand.SQL.Add ( 'insert into avancesglobales values (:contrato, :convenio, :fecha, :orden, 3, :ponderadodia, :ponderadoglobal, 0)') ;
                 connection.zCommand.Params.ParamByName('contrato').DataType := ftString ;
                 connection.zCommand.Params.ParamByName('contrato').Value := Global_Contrato ;
                 connection.zCommand.Params.ParamByName('convenio').DataType := ftString ;
                 connection.zCommand.Params.ParamByName('convenio').Value := Global_Convenio ;
        ...
        Begin
            ...
            Begin
                ...
                While Int(dFechaInicial) <= Int(Connection.qryBusca2.FieldValues['dffProgramado'])  Do
                Begin
                    QryActividadesxOrden.First ;
                    While NOT QryActividadesxOrden.Eof Do
                    Begin
