...
//empieza validacion
  ...
  if not validaTexto(nombres, cadenas, 'Isometrico', tsDescripcion.Text) then
  begin
...
procedure TfrmIsometricosNuevo.Copy1Click(Sender: TObject);
begin
UtGrid.AddRowsFromClip;
end;

procedure TfrmIsometricosNuevo.Cut1Click(Sender: TObject);
begin
...
procedure TfrmIsometricosNuevo.grid_GruposIsometricoMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmIsometricosNuevo.grid_GruposIsometricoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmIsometricosNuevo.grid_GruposIsometricoTitleClick(
  Column: TColumn);
begin
