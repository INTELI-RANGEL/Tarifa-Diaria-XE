...
uses
  ...
  Dialogs, frm_connection, StdCtrls, DBCtrls, ExtCtrls, DB,
  Grids, DBGrids, global, Buttons, RXDBCtrl, frxClass,UnitTBotonesPermisos,
  frxDBSet, ZAbstractRODataset, ZDataset, Newpanel, Utilerias, strUtils,
...
try
 ...
 begin
  ...
  if not FileExists(global_files + 'AnexoC.fr3') then
   showmessage('El archivo de reporte AnexoC.fr3 no existe, notifique al administrador del sistema');
 end
 else
