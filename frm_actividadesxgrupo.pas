...
procedure TfrmActividadesxGrupo.Copiar1Click(Sender: TObject);
begin
...
begin
    ...
    Begin
       ...
       ActividadesxGrupo.Open
    End ;
    tsGrupo.Color := global_color_salida
end;
...
begin
    tsGrupo.Color := global_color_entrada
end;
...
procedure TfrmActividadesxGrupo.grid_paquetesMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
if grid_paquetes.datasource.DataSet.IsEmpty=false  then
if grid_paquetes.DataSource.DataSet.RecordCount>0 then
...
procedure TfrmActividadesxGrupo.grid_paquetesMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
if grid_paquetes.datasource.DataSet.IsEmpty=false  then
if grid_paquetes.DataSource.DataSet.RecordCount>0 then
...
procedure TfrmActividadesxGrupo.grid_paquetesTitleClick(Column: TColumn);
begin
if grid_paquetes.datasource.DataSet.IsEmpty=false  then
if grid_paquetes.DataSource.DataSet.RecordCount>0 then
