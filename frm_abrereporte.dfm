object frmAbreReporte: TfrmAbreReporte
  ...
  object pgValidacion: TPageControl
    ...
    object TabReportes: TTabSheet
      ...
      object PanelProgress2: TPanel
        ...
        object BarraEstado2: TProgressBar
          Left = 8
          Top = 19
          Width = 366
          Height = 17
  ...
  object ReporteDiario: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        ', t.sOrigenTierra, r.sOrden from reportediario r'
      
        'inner join turnos t on (r.sContrato = t.sContrato And r.sIdTurno' +
        ' = t.sIdTurno)'
      
        'where  r.sOrden =:contrato And r.lStatus <> '#39'Pendiente'#39' order by' +
        ' r.dIdFecha desc')
    Params = <
      item
        DataType = ftUnknown
    ...
    object ReporteDiariosOrden: TStringField
      FieldName = 'sOrden'
      Size = 15
    end
  end
  ...
  object Requisicion: TZReadOnlyQuery
    ...
    object RequisicionsContrato: TStringField
      FieldName = 'sContrato'
      Required = True
      Size = 15
    end
    object RequisicioniFolioRequisicion: TIntegerField
      FieldName = 'iFolioRequisicion'
    end
    object RequisicionsNumeroOrden: TStringField
      FieldName = 'sNumeroOrden'
      Required = True
      Size = 35
    end
    object RequisiciondIdFecha: TDateField
      FieldName = 'dIdFecha'
    end
    object RequisiciondFechaSolicitado: TDateField
      FieldName = 'dFechaSolicitado'
    end
    object RequisiciondFechaRequerido: TDateField
      FieldName = 'dFechaRequerido'
    end
    object RequisicionsRequisita: TStringField
      FieldName = 'sRequisita'
      Required = True
      Size = 30
    end
    object RequisicionsReferencia: TStringField
      FieldName = 'sReferencia'
      Required = True
      Size = 30
    end
    object RequisicionsRevision: TStringField
      FieldName = 'sRevision'
      Size = 10
    end
    object RequisicionsSolicito: TStringField
      FieldName = 'sSolicito'
      Size = 50
    end
    object RequisicionsStatus: TStringField
      FieldName = 'sStatus'
      Required = True
      Size = 10
    end
    object RequisicionsAutorizo: TStringField
      FieldName = 'sAutorizo'
      Size = 50
    end
    object RequisicionsVerificacion: TStringField
      FieldName = 'sVerificacion'
      Size = 50
    end
    object RequisicionsRecibido: TStringField
      FieldName = 'sRecibido'
      Size = 50
    end
    object RequisicionsidDepartamento: TStringField
      FieldName = 'sidDepartamento'
      Required = True
      Size = 4
    end
    object RequisicionmComentarios: TMemoField
      FieldName = 'mComentarios'
      Required = True
      BlobType = ftMemo
    end
    object RequisicionsMotivo: TStringField
      FieldName = 'sMotivo'
      Required = True
    end
    object RequisicionsEstado: TStringField
      FieldName = 'sEstado'
      Required = True
    end
    object RequisicionsLugarEntrega: TStringField
      FieldName = 'sLugarEntrega'
      Required = True
      Size = 10
    end
    object RequisicionsNumeroSolicitud: TStringField
      FieldName = 'sNumeroSolicitud'
      Required = True
    end
    object RequisicionsCodigoMaterial: TStringField
      FieldName = 'sCodigoMaterial'
      Required = True
    end
  end
  ...
  object OrdenCompra: TZReadOnlyQuery
    ...
    object OrdenComprasContrato: TStringField
      FieldName = 'sContrato'
      Required = True
      Size = 15
    end
    object OrdenCompraiFolioPedido: TIntegerField
      FieldName = 'iFolioPedido'
    end
    object OrdenComprasOrdenCompra: TStringField
      FieldName = 'sOrdenCompra'
      Size = 30
    end
    object OrdenComprasFolioRequisicion: TStringField
      FieldName = 'sFolioRequisicion'
      Required = True
      Size = 200
    end
    object OrdenComprasIdProveedor: TStringField
      FieldName = 'sIdProveedor'
      Required = True
      Size = 4
    end
    object OrdenComprasNumeroOrden: TStringField
      FieldName = 'sNumeroOrden'
      Required = True
      Size = 35
    end
    object OrdenCompradIdFecha: TDateField
      FieldName = 'dIdFecha'
      Required = True
    end
    object OrdenCompradFechaEntrega: TDateField
      FieldName = 'dFechaEntrega'
      Required = True
    end
    object OrdenComprasReferencia: TStringField
      FieldName = 'sReferencia'
      Required = True
      Size = 30
    end
    object OrdenComprasElaboro: TStringField
      FieldName = 'sElaboro'
      Size = 60
    end
    object OrdenComprasReviso1: TStringField
      FieldName = 'sReviso1'
      Size = 60
    end
    object OrdenComprasReviso2: TStringField
      FieldName = 'sReviso2'
      Size = 60
    end
    object OrdenComprasAutorizo: TStringField
      FieldName = 'sAutorizo'
      Size = 60
    end
    object OrdenComprasMedioTransporte: TStringField
      FieldName = 'sMedioTransporte'
      Size = 45
    end
    object OrdenComprasFormaPago: TStringField
      FieldName = 'sFormaPago'
      Size = 15
    end
    object OrdenCompraiPeriodoPago: TIntegerField
      FieldName = 'iPeriodoPago'
    end
    object OrdenCompralUnicoProveedor: TStringField
      FieldName = 'lUnicoProveedor'
      Size = 2
    end
    object OrdenComprasMoneda: TStringField
      FieldName = 'sMoneda'
      Required = True
      Size = 5
    end
    object OrdenCompradCambio: TFloatField
      FieldName = 'dCambio'
      Required = True
    end
    object OrdenCompradIVA: TFloatField
      FieldName = 'dIVA'
      Required = True
    end
    object OrdenCompradDescuento: TFloatField
      FieldName = 'dDescuento'
    end
    object OrdenCompramComentarios: TMemoField
      FieldName = 'mComentarios'
      BlobType = ftMemo
    end
    object OrdenComprasStatus: TStringField
      FieldName = 'sStatus'
      Required = True
      Size = 10
    end
    object OrdenComprasLugarEntrega: TStringField
      FieldName = 'sLugarEntrega'
      Required = True
      Size = 250
    end
    object OrdenComprasCondiciones: TStringField
      FieldName = 'sCondiciones'
      Required = True
      Size = 250
    end
    object OrdenComprasEntrega: TStringField
      FieldName = 'sEntrega'
      Required = True
      Size = 250
    end
    object OrdenComprasPrecios: TStringField
      FieldName = 'sPrecios'
      Required = True
      Size = 250
    end
    object OrdenComprasVigencia: TStringField
      FieldName = 'sVigencia'
      Required = True
      Size = 250
    end
    object OrdenComprasVendedor: TStringField
      FieldName = 'sVendedor'
      Required = True
      Size = 50
    end
    object OrdenComprasMail: TStringField
      FieldName = 'sMail'
      Required = True
      Size = 50
    end
  ...
  object PopSistemas: TPopupMenu
    ...
    object DesvalidacionTodos: TMenuItem
      Caption = 'DesValida Todas las Ordenes'
      OnClick = DesvalidacionTodosClick
    end
    object DesautorizacionTodos: TMenuItem
      Caption = 'DesAutoriza Todas las Ordenes'
      OnClick = DesautorizacionTodosClick
    end
  end
end
