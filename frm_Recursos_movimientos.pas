...
procedure TfrmRecursosMovimientos.grid_pernoctanMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmRecursosMovimientos.grid_pernoctanMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmRecursosMovimientos.grid_pernoctanTitleClick(Column: TColumn);
begin
...
procedure TfrmRecursosMovimientos.Pegar1Click(Sender: TObject);
begin
...
procedure TfrmRecursosMovimientos.Copiar1Click(Sender: TObject);
begin
