...
uses
  ...
  Dialogs, StdCtrls, Buttons, frm_connection, global, 
  Sockets,  DB, 
...
begin
    tsPassword1.Color := global_color_entrada
end;

procedure Tfrmcambiopassword.tsPassword1Exit(Sender: TObject);
begin
    tsPassword1.Color := global_color_salida
end;
...
begin
    tsPassword2.Color := global_color_entrada
end;

procedure Tfrmcambiopassword.tsPassword2Exit(Sender: TObject);
begin
    tsPassword2.Color := global_color_salida
end;
