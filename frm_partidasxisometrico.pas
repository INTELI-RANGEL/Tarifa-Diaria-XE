...
uses
  ...
  Dialogs, frm_connection, global, 
  StdCtrls, ExtCtrls, DBCtrls, adodb, db, Menus, OleCtrls,
...
begin
      ...
      begin
          ...
          if not FileExists(global_files + 'ResumidoInstalacionporplano.fr3') then
...
begin
      ...
      begin
          ...
          frxImpresion.LoadFromFile(Global_Files+'DetalleInstalacionporplano.fr3') ;
          frxImpresion.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
          if not FileExists(global_files + 'DetalleInstalacionporplano.fr3') then
