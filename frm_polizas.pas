...
begin
    tsFolio.Color := global_color_entrada
end;

procedure TfrmPolizas.tsFolioExit(Sender: TObject);
begin
    tsFolio.Color := global_color_salida
end;
...
begin
    tsEmisor.Color := global_color_entrada
end;

procedure TfrmPolizas.tsEmisorExit(Sender: TObject);
begin
    tsEmisor.Color := global_color_salida
end;
