...
var
  ...
  rAncho :Integer= 17;      // Número de columnas correspondientes a datos generales de partidas
  rAlto :Integer = 11;       // Número de renglones correspondientes al encabezado
implementation
...
Begin
  ...
  oGantt.Selection.Value := 'DURACIÓN';
  oGantt.Selection.Font.bold:=true;
  oGantt.Selection.MergeCells := True;
  oGantt.Selection.VerticalAlignment := xlCenter;
  oGantt.Selection.HorizontalAlignment := xlCenter;
...
{      if CheckBox2.Checked then
 ...
 //Selection.ShapeRange.Fill.Visible = msoFalse
  ...
  oGantt.Selection.Font.Bold := True;
  oGantt.Selection.WrapText := True;
  oGantt.Selection.Value :='LOCALIZACIÓN:' ;
...
begin
  ...
  begin
    rAncho:=6;
    rAlto:=14;
     SdgExcel.FileName := 'Gráfica de GANTT de seguimiento - ' + mContrato + '.xlsx';
