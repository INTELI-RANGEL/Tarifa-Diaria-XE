...
type
  TfrmTurnos = class(TForm)
    ...
    procedure grid_turnosMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure grid_turnosMouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure grid_turnosTitleClick(Column: TColumn);
...
procedure TfrmTurnos.grid_turnosMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
 UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmTurnos.grid_turnosMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmTurnos.grid_turnosTitleClick(Column: TColumn);
begin
...
begin
    tsOrigenTierra.Color := global_color_entrada
end;

procedure TfrmTurnos.tsOrigenTierraExit(Sender: TObject);
begin
    tsOrigenTierra.Color := global_color_salida
end;
