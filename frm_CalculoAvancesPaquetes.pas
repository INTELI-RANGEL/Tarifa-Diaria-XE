...
uses
  ...
  ComCtrls, ZAbstractRODataset, ZDataset, Gauges, masUtilerias,
...
//Verifica que la fecha final no sea menor que la fecha inicio
 ...
 try
    ...
    Kardex('Regeneraciones', 'Regenera entregables', sRangoKardex, 'Rango de Fechas', tsNumeroOrden.Text, '', '','Tarifa Diaria','Regeneracion de Avances Entregable');
    //****************************BRITO 09/02/11********************************
