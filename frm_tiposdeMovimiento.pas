...
type
  TfrmTiposdeMovimiento = class(TForm)
    grid_tiposdemovimiento: TDBGrid;
    Label1: TLabel;
    Label2: TLabel;
    ...
    TiposdeMovimientolAplicaNotaCampo: TStringField;
    DbCmbNota: TDBComboBox;
    Label9: TLabel;
    Label10: TLabel;
    tdImprimeCeros: TDBComboBox;
    TiposdeMovimientolImprimeCeros: TStringField;
    procedure tsIdEmbarcacionKeyPress(Sender: TObject; var Key: Char);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
    procedure FormShow(Sender: TObject);
    procedure grid_tiposdemovimientoCellClick(Column: TColumn);
    ...
    procedure grid_tiposdemovimientoMouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure grid_tiposdemovimientoMouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure grid_tiposdemovimientoTitleClick(Column: TColumn);
...
begin
  ...
  begin
    ...
    begin
      ...
      tsClasificacion.Items.Add(item);
    end;
  end;
...
procedure TfrmTiposdeMovimiento.grid_tiposdemovimientoCellClick(Column: TColumn);
begin
  if frmBarra1.btnCancel.Enabled = True then
      frmBarra1.btnCancel.Click ;
end;

procedure TfrmTiposdeMovimiento.grid_tiposdemovimientoMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmTiposdeMovimiento.grid_tiposdemovimientoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
procedure TfrmTiposdeMovimiento.grid_tiposdemovimientoTitleClick(
  Column: TColumn);
begin
...
//MessageDlg( inttostr ( cmbColor.Selected ) , mtInformation, [mbOk], 0);
   try                                      //estaba como comentario
      //TiposdeMovimiento.FieldValues['iColor'] :=TiColores.ColorValue;                     //    tiColor.Text ;
...
begin
    tlGrafica.Color := global_color_entrada
end;

procedure TfrmTiposdeMovimiento.tlGraficaExit(Sender: TObject);
begin
    tlGrafica.Color := global_color_salida
end;
...
begin
    tiOrden.color := global_color_entrada
end;

procedure TfrmTiposdeMovimiento.tiOrdenExit(Sender: TObject);
begin
    tiOrden.color := global_color_salida
end;
...
begin
  ...
  //tiColores.ColorValue:=TColor(TiposdeMovimiento.FieldByName('iColor').AsInteger);
end;
