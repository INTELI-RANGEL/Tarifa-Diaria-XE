...
uses
  ...
  Dialogs, StdCtrls, DBCtrls, ComCtrls, Grids, DBGrids, frm_barra, frm_connection, global, DB,
  ...
  unitactivapop, DBDateTimePicker;
...
type
  TfrmTramitedePermisos = class(TForm)
    ...
    grid_tramitedepermisos: TRxDBGrid;
    ...
    procedure grid_tramitedepermisosGetCellParams(Sender: TObject;
      Field: TField; AFont: TFont; var Background: TColor;
      Highlight: Boolean);
    procedure TramitedePermisosCalcFields(DataSet: TDataSet);
    procedure grid_tramitedepermisosMouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure grid_tramitedepermisosMouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure grid_tramitedepermisosTitleClick(Column: TColumn);
...
begin
    tsIdTipoPermiso.Color := global_color_entrada
end;

procedure TfrmTramitedePermisos.tsIdTipoPermisoExit(Sender: TObject);
begin
    tsIdTipoPermiso.Color := global_color_salida
end;

procedure TfrmTramitedePermisos.tsFoliosEnter(Sender: TObject);
begin
    tsFolios.Color := global_color_entrada
end;

procedure TfrmTramitedePermisos.tsFoliosExit(Sender: TObject);
begin
    tsFolios.Color := global_color_salida
end;

procedure TfrmTramitedePermisos.grid_tramitedepermisosEnter(
  Sender: TObject);
begin
...
procedure TfrmTramitedePermisos.grid_tramitedepermisosGetCellParams(
...
procedure TfrmTramitedePermisos.grid_tramitedepermisosMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmTramitedePermisos.grid_tramitedepermisosMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmTramitedePermisos.grid_tramitedepermisosTitleClick(
  Column: TColumn);
begin
