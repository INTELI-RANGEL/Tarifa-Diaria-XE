...
type
  TfrmPlataformas = class(TForm)
    ...
    procedure PlataformasAfterScroll(DataSet: TDataSet);
...
begin
  ...
  try
      ...
      if ModoSel and (global_frmActivo = 'frm_ordenes') and (Assigned(frmordenes)) then
         frmordenes.EstablecePlataforma(idseleccionado);
...
procedure TfrmPlataformas.PlataformasAfterScroll(DataSet: TDataSet);
begin
  IdSeleccionado := Plataformas.FieldByName('sidplataforma').AsString;
  Seleccionado :=   Plataformas.FieldByName('sdescripcion').AsString;
end;
