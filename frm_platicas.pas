...
uses
  ...
  DBGrids, ComCtrls, global, DB, Menus, 
...
begin
     cmbFecha.Color := global_color_entrada;
end;

procedure TfrmPlaticas.cmbFechaExit(Sender: TObject);
begin
     cmbFecha.Color := global_color_salida;
end;
...
begin
    cmbFrente.Color := global_color_entrada;
end;

procedure TfrmPlaticas.cmbFrenteExit(Sender: TObject);
begin
     cmbFrente.Color := global_color_salida;
end;
...
begin
     cmbOrden.Color := global_color_entrada;
end;

procedure TfrmPlaticas.cmbOrdenExit(Sender: TObject);
begin
     cmbOrden.Color := global_color_salida;
end;
