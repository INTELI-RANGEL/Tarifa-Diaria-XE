...
type
  TfrmTripulacion = class(TForm)
    ...
    procedure grid_tripulacionCellClick(Column: TColumn);
...
procedure TfrmTripulacion.grid_tripulacionCellClick(Column: TColumn);
begin
...
procedure TfrmTripulacion.grid_tripulacionMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
   UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmTripulacion.grid_tripulacionMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
   UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmTripulacion.grid_tripulacionTitleClick(Column: TColumn);
begin
...
begin
    tsIdTripulacionGrupo.Color := global_Color_entrada;
end;

procedure TfrmTripulacion.tsIdTripulacionGrupoExit(Sender: TObject);
begin
    tsIdTripulacionGrupo.Color := global_Color_salida;
end;
...
begin
    tiNacionales.Color := global_color_entrada
end;

procedure TfrmTripulacion.tiNacionalesExit(Sender: TObject);
begin
    tiNacionales.Color := global_color_salida
end;
...
begin
    tiExtranjeros.Color := global_color_entrada
end;

procedure TfrmTripulacion.tiExtranjerosExit(Sender: TObject);
begin
    tiExtranjeros.Color := global_color_salida
end;
...
begin
 ...
 begin
    ...
    If QryTripulacionOficio.RecordCount > 0 Then
     if True then
      frxTripulacion.LoadFromFile (global_files + 'tripulacion.fr3') ;
    ...
    if not FileExists(global_files + 'tripulacion.fr3') then
