...
const
  ...
  global_version = 'Sistema Inteligente para la Administración de Contratos - Tarifa Diaria Beta ';
var
  global_barco,
    global_ipServer,
    global_ruta,
  ...
  sSupervisorSubContratista,
    sPuestoSupervisorSubContratista, sFirmante_CalidadRIR, sPuesto_CalidadRIR: string;
