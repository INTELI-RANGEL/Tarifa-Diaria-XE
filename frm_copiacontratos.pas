...
uses
  ...
  Buttons, Grids, ExtCtrls, Mask, JvExMask, JvToolEdit, JvCombobox,
  DBCtrls, Global,JvExControls, JvBitmapButton, BaseGrid,
  AdvGrid, DBAdvGrid, AdvOfficePager, AdvOfficePagerStylers, AdvOfficeButtons,
  GradientLabel, sLabel, UnitExcepciones,
  AdvObj;
...
begin
  ...
  'lProrrateo, lCobro, lImprime, lAplicaTM, iJornada, lDistribuye, sAgrupaPersonal) ' +
  ...
  ':imprime, :aplicatm, :jornada, :distribuye, :agrupapersonal)');
