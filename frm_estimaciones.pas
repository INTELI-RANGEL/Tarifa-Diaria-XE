...
uses
  ...
  ToolWin,  RXDBCtrl, Buttons, DateUtils,
   FramedPanel, UnitExcepciones,
  Sockets, Newpanel, utilerias, ZAbstractRODataset,
...
begin
if grid_estimaciones.DataSource.DataSet.IsEmpty=true then
begin
...
begin
  ...
  If CompareText(VarName, 'ESTIMACION') = 0 then
      Value := GeneradoresxEstimacion.FieldValues['iNumeroEstimacion'] ;
...
procedure TfrmEstimaciones.Grid_GeneradoresGetCellParams(Sender: TObject;
...
procedure TfrmEstimaciones.Grid_GeneradoresMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
if grid_generadores.datasource.DataSet.IsEmpty=false  then
if grid_generadores.DataSource.DataSet.RecordCount>0 then
UtGrid2.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmEstimaciones.Grid_GeneradoresMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
if grid_generadores.datasource.DataSet.IsEmpty=false  then
if grid_generadores.DataSource.DataSet.RecordCount>0 then
...
procedure TfrmEstimaciones.Grid_GeneradoresTitleClick(Column: TColumn);
begin
if grid_generadores.datasource.DataSet.IsEmpty=false  then
if grid_generadores.DataSource.DataSet.RecordCount>0 then
...
procedure TfrmEstimaciones.Grid_GeneradoresDblClick(Sender: TObject);
begin
try
  If GeneradoresxEstimacion.RecordCount > 0 Then
  begin
...
try
  ...
  If Global_contrato= global_Contrato_Barco Then
     QryConcentradoIsometricos.SQL.Add('select e2.iNumeroEstimacion, e.sWbs, e.sNumeroActividad, a.mDescripcion, a.sMedida, a.dVentaMN, a.dCantidadAnexo as dCantidadInstalar, ' +
  ...
  begin
    ...
    frIsometricos.LoadFromFile (global_files + 'IsometricosxEstimacion.fr3') ;
    ...
    if not FileExists(global_files + 'IsometricosxEstimacion.fr3') then
...
try
  ...
  QryConcentradoIsometricos.SQL.Clear ;
  If Global_contrato= global_Contrato_Barco Then
    QryConcentradoIsometricos.SQL.Add('select e2.iNumeroEstimacion, e2.sNumeroOrden, e.sWbs, e.sNumeroActividad, a.mDescripcion, a.sMedida, a.dVentaMN, a.dCantidadAnexo as dCantidadInstalar, ' +
                                    'e.sIsometrico, e.sPrefijo, e.dCantidad from estimacionxpartida e ' +
                                    'inner join estimaciones e2 on (e2.sContrato = e.sContrato and e2.sNumeroOrden = e.sNumeroOrden and e2.sNumeroGenerador = e.sNumeroGenerador and e2.iNumeroEstimacion <= :Estimacion)' +
                                    'inner join actividadesxanexo a on (e.sContrato = a.sContrato and ' +
  ...
  begin
    ...
    frIsometricos.PreviewOptions.ShowCaptions := False ;
    frIsometricos.Previewoptions.ZoomMode := zmPageWidth ;
    frIsometricos.LoadFromFile (global_files + 'ConcentradoIsometricosxEstimacion.fr3') ;
    frIsometricos.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
    if not FileExists(global_files + 'ConcentradoIsometricosxEstimacion.fr3') then
...
try
  ...
  QryConcentradoIsometricos.Active := False ;
  QryConcentradoIsometricos.SQL.Clear ;
  QryConcentradoIsometricos.SQL.Add('select e2.iNumeroEstimacion, e2.sNumeroOrden, e2.sNumeroGenerador, e.sWbs, e.sNumeroActividad, a.mDescripcion, a.sMedida, a.dVentaMN, a.dCantidadAnexo as dCantidadInstalar, ' +
  ...
  begin
    ...
    frIsometricos.PreviewOptions.ShowCaptions := False ;
    frIsometricos.Previewoptions.ZoomMode := zmPageWidth ;
    frIsometricos.LoadFromFile (global_files + 'GeneradoresxEstimacion.fr3') ;
    frIsometricos.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
    if not FileExists(global_files + 'GeneradoresxEstimacion.fr3') then
...
try
  ...
  QryConcentradoIsometricos.Active := False ;
  QryConcentradoIsometricos.SQL.Clear ;
  QryConcentradoIsometricos.SQL.Add('select e2.iNumeroEstimacion, e2.mComentarios, e3.dFechaInicio, e3.dFechaFinal, e2.sNumeroOrden, e2.sNumeroGenerador, e.sWbs, e.sNumeroActividad, a.mDescripcion, a.sMedida, a.dVentaMN, a.dVentaDLL, a.dCantidadAnexo as dCantidadInstalar, ' +
                                    'sum(e.dCantidad) as dCantidad from estimacionxpartida e ' +
  ...
  begin
    ...
    frIsometricos.PreviewOptions.ShowCaptions := False ;
    frIsometricos.Previewoptions.ZoomMode := zmPageWidth ;
    frIsometricos.LoadFromFile (global_files + 'DetalledeGeneradoresExt.fr3') ;
    frIsometricos.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
    if not FileExists(global_files + 'DetalledeGeneradoresExt.fr3') then
...
begin
  try
    ...
    connection.QryBusca.Active := False ;
    connection.QryBusca.SQL.Clear ;
    connection.QryBusca.SQL.Add('Select e.iNumeroEstimacion, e.sEspecificacion, e.sWbs, e.sWbs as sConcepto, e.mDescripcion, e.sMedida, ' +
...
try
  ...
  begin
    ...
    frIsometricos.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
    frIsometricos.Destroy ;
    if not FileExists(global_files + 'DetalledeGeneradores.fr3') then
