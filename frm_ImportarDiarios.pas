...
uses
  ...
  ADODB, global, Buttons, RXCtrls, StrUtils, 
  Gauges, Menus, utilerias, ZAbstractRODataset, ZDataset, 
  ...
  cxListView, cxShellListView, cxGraphics, dxSkinsCore, dxSkinBlack, dxSkinBlue,
