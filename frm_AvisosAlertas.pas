...
uses
  ...
  ZDataset, rxToolEdit, unitexcepciones, udbgrid, UnitValidacion,
...
begin
    tiMessage.Color := global_color_entrada
end;
...
begin
    If frmBarra1.btnCancel.Enabled = True Then
        ...
        begin
            ...
            tiMessage.SetFocus
        End ;
    tiMessage.Color := global_color_salida
end;
...
begin
    tsAutor.Color := global_color_entrada
end;

procedure TfrmAvisosAlertas.tsAutorExit(Sender: TObject);
begin
    tsAutor.Color := global_color_salida
end;
