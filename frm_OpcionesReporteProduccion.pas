...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, frm_connection, global, ExtCtrls, DBCtrls, Mask,
  db, Menus, OleCtrls, frxClass, frxDBSet, Buttons, RxMemDS, utilerias, RXCtrls,
   ZAbstractRODataset, ZDataset, ZAbstractDataset, AdvPageControl,
   NxCollection, AdvGlowButton, NxScrollControl, NxCustomGridControl,
   NxCustomGrid, NxDBGrid, NxDBColumns, NxColumns, rxToolEdit, rxCurrEdit;
type
