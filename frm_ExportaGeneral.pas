...
uses
  ...
  Dialogs, ComCtrls, StdCtrls, Buttons, frm_connection, DB, ADODB, DBCtrls,
  global, StrUtils, utilerias, OleServer, ComObj, ZAbstractRODataset, ZDataset,
  unitexcepciones, ShlObj, cxShellCommon, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxContainer, cxEdit, cxTreeView, cxShellTreeView,
...
//    fContenido: TShellListView;
    ...
    fDirectorio: TcxShellTreeView;
    fContenido: TcxShellListView;
