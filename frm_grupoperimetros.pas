...
type
  Tfrmgrupoperimetros = class(TForm)
    ...
    procedure gridgrupoperimetrosTitleClick(Column: TColumn);
  private
    sMenuP: String;
...
procedure Tfrmgrupoperimetros.gridgrupoperimetrosTitleClick(Column: TColumn);
begin
...
begin
  tsSimbolo.Color:=global_color_entrada
end;

procedure Tfrmgrupoperimetros.tsSimboloExit(Sender: TObject);
begin
  tsSimbolo.Color:=global_color_salida
end;
