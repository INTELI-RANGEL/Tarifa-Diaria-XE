...
uses
  ...
  StdCtrls, ExtCtrls, DBCtrls, Mask, db, Menus, OleCtrls,
  frxClass, frxDBSet, Buttons, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, rxToolEdit, RXDBCtrl, RxRichEd,udbgrid,
  unitexcepciones, UnitValidaTexto, unittbotonespermisos, UFunctionsGHH;
...
didfecha.DateTime:=Now;
  try
    ...
    qryActividadDiaAnterior.Params.ParamByName('Contrato').Value := param_global_contrato;
...
begin
  ...
  ComentariosxAnexo.FieldValues['sContrato'] := param_global_contrato;
...
begin
  ...
  ComentariosxAnexo.Params.ParamByName('Contrato').Value := param_global_contrato;
