...
uses
  ...
  Grids, DBGrids, RXDBCtrl, Newpanel, global, ComCtrls, Buttons, 
...
begin
  ...
  UtGrid:=TicdbGrid.create(gridpartidas);
  UtGrid2:=TicdbGrid.create(gridcanceladas);
...
begin
   ...
   frxCanceladas.LoadFromFile(Global_Files+'frActividadesCanceladas.fr3') ;
   frxCanceladas.ShowReport;    //(connection.configuracion.FieldByName('sFormatos').AsString, PermisosExportar(connection.zConnection, global_grupo, sMenuP));
