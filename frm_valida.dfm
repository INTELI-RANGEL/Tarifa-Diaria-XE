object frmValida: TfrmValida
  ...
  object ReporteDiario: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        ', t.sOrigenTierra, r.sIdUsuarioBarco, r.sOrden from reportediari' +
        'o r'
      
        'inner join turnos t on (r.sContrato = t.sContrato And r.sIdTurno' +
        ' = t.sIdTurno)'
      
        'where r.sOrden= :contrato And r.lStatus <> '#39'Autorizado'#39' order by' +
        ' r.dIdFecha desc')
    Params = <
      item
        DataType = ftUnknown
  ...
  object EstimacionPeriodo: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'dMontoMN, dRetencionMN From estimacionperiodo Where sContrato = ' +
        ':Contrato And lEstimado = "No" Order By iNumeroEstimacion')
    Params = <
      item
        DataType = ftUnknown
        Name = 'Contrato'
