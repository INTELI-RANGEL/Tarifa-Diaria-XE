...
uses
  ...
  frxClass, frxDBSet, DB, StrUtils, Global, frm_connection, StdCtrls, ExtCtrls, Mask, 
  DBCtrls, Grids, DBGrids, ADODB, Buttons, UnitExcepciones,
  RXToolEdit, Utilerias, UReporteDiarioMix, udbgrid,
  DBDateTimePicker, 
  masUtilerias, Gauges, rxSpeedbar;
...
uses frm_ReporteDiarioTurno, frm_seguridad, frm_jornadasdiarias, 
...
procedure TfrmPrintReportesDiarios.BitBtn1Click(Sender: TObject);
var
   Progreso, TotalProgreso : double;
begin
     if edtdirectorio.Text = '' then
     begin
         messageDLG('Seleccione un directorio!', mtInformation, [mbOk], 0);
         exit;
     end;

     global_directorio     := edtdirectorio.Text;
...
begin
     if trim(edtdirectorio.Text) = '' then
...
procedure TfrmPrintReportesDiarios.Grid_ReportesDblClick(Sender: TObject);
begin
...
procedure TfrmPrintReportesDiarios.Grid_ReportesMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmPrintReportesDiarios.Grid_ReportesMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmPrintReportesDiarios.Grid_ReportesTitleClick(Column: TColumn);
begin
