...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, DB, ZAbstractRODataset, ZDataset, 
  UTChartMarco, UTChartMouse, RxGIF, Buttons, 
  Global, frm_Connection, Mask, DBCtrls, 
...
begin
    cbordenes.Color := global_color_entrada;
end;

procedure TIntelChart.cbOrdenesExit(Sender: TObject);
begin
    cbordenes.Color := global_color_salida;
end;
