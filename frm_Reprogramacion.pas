...
uses
  ...
  Menus, RXDBCtrl, ExtDlgs, jpeg,unitValidacion,
...
begin
  ...
  try
      ...
      if Convenios.State = dsEdit then
         Kardex('Reprogramaciones','Edita Registro', Convenios.FieldValues['sIdConvenio'], 'Convenio', '', '', '','Tarifa Diaria','Reprogramaciones' )
      else
         Kardex('Reprogramaciones','Crea  Registro', Convenios.FieldValues['sIdConvenio'], 'Convenio', '', '', '','Tarifa Diaria','Reprogramaciones' );
      Convenios.Post ;
    ...
    begin
      try
         ...
         begin
             ...
             Convenios.Delete ;
             Kardex('Reprogramaciones','Borra Registro', OldConvenio, 'Convenio', '', '', '','Tarifa Diaria','Reprogramaciones' )
      except
        on e : exception do begin
...
begin
    tsIdTipoConvenio.Color := global_color_entrada
end;

procedure TfrmReprogramacion.tsIdTipoConvenioExit(Sender: TObject);
begin
    tsIdTipoConvenio.Color := global_color_salida
end;
...
procedure TfrmReprogramacion.Grid_ConveniosMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
UtGrid.dbGridMouseMoveCoord(x,y);
end;

procedure TfrmReprogramacion.Grid_ConveniosMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
UtGrid.DbGridMouseUp(Sender,Button,Shift,X, Y);
end;

procedure TfrmReprogramacion.Grid_ConveniosTitleClick(Column: TColumn);
begin
...
begin
    tDuracion.Color := global_color_entrada;
end;

procedure TfrmReprogramacion.tDuracionExit(Sender: TObject);
begin
    tDuracion.Color := global_Color_salida;
end;
...
begin
    tlAvanceFisico.Color := global_color_entrada
end;

procedure TfrmReprogramacion.tlAvanceFisicoExit(Sender: TObject);
begin
    tlAvanceFisico.Color := global_color_salida
end;
...
begin
dbanexo.color:=global_color_entrada;
end;

procedure TfrmReprogramacion.dbAnexoExit(Sender: TObject);
begin
dbanexo.color:=global_color_salida;
end;
...
begin
    tdImporteMN.Color := global_color_entrada
end;

procedure TfrmReprogramacion.tdImporteMNExit(Sender: TObject);
begin
    tdImporteMN.Color := global_color_salida
end;
...
begin
    tdImporteDLL.Color := global_color_entrada
end;

procedure TfrmReprogramacion.tdImporteDLLExit(Sender: TObject);
begin
    tdImporteDLL.Color := global_color_salida
end;
