...
procedure TfrmGrupos.grid_fasesCellClick(Column: TColumn);
begin
...
begin
    sMail.Color := global_color_entrada
end;
...
begin
      ...
      begin
          ...
          sMail.Color := global_color_salida
end;
...
begin
      sPassword.Color := global_color_entrada
end;

procedure TfrmGrupos.sPasswordExit(Sender: TObject);
begin
     sPassword.Color := global_color_salida
end;
