...
uses
  ...
  AdvPanel, NxPageControl, ZAbstractRODataset, ZAbstractDataset, DB;
...
uses UFunctionsGHH, frm_connection, 
  frm_ActualizaAvancesRemotos;
...
begin
  ...
  frmActualizacionRemota.CargarNxGrid(frmActualizacionRemota.NxGridSinc);
