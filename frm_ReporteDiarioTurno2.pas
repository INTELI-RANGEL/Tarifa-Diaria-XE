...
uses
  ...
  Menus, OleCtrls, ExtCtrls, frm_barra, frxClass,
  frxDBSet, Jpeg, RxMemDS, rxToolEdit, rxCurrEdit, ZAbstractRODataset, ZDataset,
  ZAbstractDataset, JvMemoryDataset;
...
type
  TfrmDiarioTurno2 = class(TForm)
    ...
    Td_duracion: TfrxDBDataset;
    Td_balance: TfrxDBDataset;
    Td_balanceResumen: TfrxDBDataset;
    ...
    Td_ImpNotasGrales: TfrxDBDataset;
    Td_ImpBalance: TfrxDBDataset;
    Td_ImpPartidas: TfrxDBDataset;
    Td_ImpConsumoEquipos: TfrxDBDataset;
    Td_ImpFotografico: TfrxDBDataset;
    Td_ImpMovimientos: TfrxDBDataset;
    Td_CDistribucionPer: TfrxDBDataset;
    Td_CDistribucionDetPer: TfrxDBDataset;
    Td_CImpDistribucionPer: TfrxDBDataset;
    Td_CImpListadoPer: TfrxDBDataset;
    Td_CListadoPer: TfrxDBDataset;
    Td_Fotografico: TfrxDBDataset;
    Td_ResumenPersonal: TfrxDBDataset;
    Td_NotasResumenP: TfrxDBDataset;
    Td_ImpResumenPersonal: TfrxDBDataset;
    Td_PartidasAnexo: TfrxDBDataset;
...
Var
    ...
    BlobField : tField ;
begin
  //Td_ImpDistribucion_detalle2.DataSet.FieldByName('dia1').AsFloat
