...
procedure TfrmRecursosxAnexonuevos.Grid_ActividadesDblClick(
  Sender: TObject);
var
   sCondicion : String ;
   sSelect    : String ;
...
procedure TfrmRecursosxAnexonuevos.Grid_ActividadesGetCellParams(
...
begin
    ...
    frxht.LoadFromFile (global_files + 'ht.fr3') ;
    frxht.ShowReport ;
end;
...
begin
    ...
    frxht.PreviewOptions.ShowCaptions := False ;
    frxht.Previewoptions.ZoomMode := zmPageWidth ;
    frxht.LoadFromFile (global_files + 'seguimiento_recursosanexo.fr3') ;
    frxht.ShowReport ;
end;
