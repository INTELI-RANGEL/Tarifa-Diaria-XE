...
uses
  ...
  Dialogs, ComCtrls, StdCtrls,  DB, ADODB, DBCtrls, global, 
  Mask, OleCtrls, Grids, DBGrids, frm_barra, ExtCtrls, Utilerias,
  Menus,  RXDBCtrl,  
  RXCtrls, CheckLst, ImgList, frxChBox,
  ZAbstractRODataset, ZDataset, rxToolEdit,
...
uses frm_connection, frm_OrdendeCambioP, frm_estimainstalado;
...
begin
    ...
    UtGrid:=TicdbGrid.create(grid_ordenesdecambio);
...
procedure TfrmOrdendeCambio.Copy1Click(Sender: TObject);
begin
...
begin
    tiCedulaProcedencia.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tiCedulaProcedenciaExit(Sender: TObject);
begin
    tiCedulaProcedencia.Color := global_color_salida
end;
...
begin
    tdMontoRequerido.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tdMontoRequeridoExit(Sender: TObject);
begin
    tdMontoRequerido.Color := global_color_salida
end;
...
begin
    tiPlazo.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tiPlazoExit(Sender: TObject);
begin
    tiPlazo.Color := global_Color_salida
end;
...
begin
    tsSoporte.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tsSoporteExit(Sender: TObject);
begin
    tsSoporte.Color := global_color_salida
end;
...
procedure TfrmOrdendeCambio.tmNotificacionDescripcionEnter(
  Sender: TObject);
begin
    tmNotificacionDescripcion.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tmNotificacionDescripcionExit(Sender: TObject);
begin
    tmNotificacionDescripcion.Color := global_Color_salida
end;
...
procedure TfrmOrdendeCambio.tiNotificacionEntregaPropuestaEnter(
  Sender: TObject);
begin
    tiNotificacionEntregaPropuesta.Color := global_color_entrada
end;
...
procedure TfrmOrdendeCambio.tsNotificacionOtroRequerimientoEnter(
  Sender: TObject);
begin
    tsNotificacionOtroRequerimiento.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tsNotificacionOtroRequerimientoExit(
  Sender: TObject);
begin
    tsNotificacionOtroRequerimiento.Color := global_color_salida
end;
...
begin
    tsOrdenCambio.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tsOrdenCambioExit(Sender: TObject);
begin
    tsOrdenCambio.Color := global_Color_salida
end;
...
begin
    tdOrdenFecha.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tdOrdenFechaExit(Sender: TObject);
begin
    tdOrdenFecha.Color := global_Color_salida
end;
...
begin
    tdOrdenMonto.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tdOrdenMontoExit(Sender: TObject);
begin
    tdOrdenMonto.Color := global_color_salida
end;
...
begin
    tiOrdenPlazo.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tiOrdenPlazoExit(Sender: TObject);
begin
    tiOrdenPlazo.Color := global_Color_salida
end;
...
begin
    tdNotificacionFecha.Color := global_Color_salida
end;
...
begin
    If Key = #13 Then
        tmNotificacionDescripcion.SetFocus
end;

procedure TfrmOrdendeCambio.tsOrdenNotificacionesdeCambioEnter(
  Sender: TObject);
begin
    tsOrdenNotificacionesdeCambio.Color := global_color_entrada
end;

procedure TfrmOrdendeCambio.tsOrdenNotificacionesdeCambioExit(
  Sender: TObject);
begin
    tsOrdenNotificacionesdeCambio.Color := global_color_salida
end;
...
begin
    tsNotificacionAntefirman.Color := global_color_Entrada
end;

procedure TfrmOrdendeCambio.tsNotificacionAntefirmanExit(Sender: TObject);
begin
    tsNotificacionAntefirman.Color := global_color_salida
end;
...
begin
    tsOrdenAntefirman.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tsOrdenAntefirmanExit(Sender: TObject);
begin
    tsOrdenAntefirman.Color := global_Color_salida
end;
...
begin
    tdOrdenFechaFirma.Color := global_color_salida
end;
...
begin
    tsDictamenAntefirman.Color := global_Color_entrada
end;

procedure TfrmOrdendeCambio.tsDictamenAntefirmanExit(Sender: TObject);
begin
    tsDictamenAntefirman.Color := global_Color_salida
end;
