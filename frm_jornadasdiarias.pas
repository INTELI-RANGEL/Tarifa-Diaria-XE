...
uses
  ...
  ClipBrd, ShellApi, UnitValidaTexto, UnitValidacion;
...
type
  TfrmJornadasDiarias = class(TForm)
    ...
    Label3: TLabel;
    Label7: TLabel;
    Grid_JornadasDiarias: TRxDBGrid;
...
begin
    If frmBarra1.btnCancel.Enabled = True Then
        tsArea.Color := global_color_entrada
end;

procedure TfrmJornadasDiarias.tsAreaExit(Sender: TObject);
begin
    If frmBarra1.btnCancel.Enabled = True Then
        tsArea.Color := global_color_salida
end;
...
begin
   tdFrente.Color := global_color_entrada
end;

procedure TfrmJornadasDiarias.tdFrenteExit(Sender: TObject);
begin
   tdFrente.Color := global_color_salida ;
end;
...
begin
    If frmBarra1.btnCancel.Enabled = True Then
        tsTiempoComida.Color := global_color_entrada
end;

procedure TfrmJornadasDiarias.tsTiempoComidaExit(Sender: TObject);
begin
    If frmBarra1.btnCancel.Enabled = True Then
        tsTiempoComida.Color := global_color_salida
end;
...
begin
    If tsTipo.ItemIndex = 0 Then
        tsHoraSalida.Color := global_Color_entrada
end;

procedure TfrmJornadasDiarias.tsHoraSalidaExit(Sender: TObject);
begin
    If tsTipo.ItemIndex = 0 Then
        tsHoraSalida.Color := global_Color_salida
end;
...
begin
    If tsTipo.ItemIndex = 0 Then
        tsHoraLlegada.Color := global_color_entrada
end;

procedure TfrmJornadasDiarias.tsHoraLlegadaExit(Sender: TObject);
begin
    If tsTipo.ItemIndex = 0 Then
        tsHoraLlegada.Color := global_color_salida ;
